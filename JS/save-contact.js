...
BEGIN:VCARD
VERSION:3.0
FN:MUHAMMAD BILAL ANWAR
TITLE:Sales Manager
ORG:RISE Properties
TEL;TYPE=WORK,VOICE:+971555625593
TEL;TYPE=WORK,VOICE:+971521450899
TEL;TYPE=WORK,VOICE:+97145665109
EMAIL:Muhammad.Bilal@riseproperties.ae
URL:http://www.riseproperties.ae
ADR;TYPE=WORK:;;PO Box No 455979, Office NO.1607, Opal Tower, Business Bay;Dubai;;UAE
END:VCARD
  `.trim();
  ...
  const a = document.createElement('a');
  a.href = url;
  a.download = 'MUHAMMAD_BILAL_ANWAR.vcf';
  document.body.appendChild(a);
  a.click();
  document.body.removeChild(a);
  URL.revokeObjectURL(url);
